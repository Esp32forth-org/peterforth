...
/*
 * ESP32forth v7.0.6.18
 * Revision: f2948cee9bd925dd7928
 */
...
#define bb0 ((uint8_t *) tos)
#define bb1 (*(uint8_t **) &n1)
#define bb2 (*(uint8_t **) &n2)
#define bb3 (*(uint8_t **) &n3)
#define bb4 (*(uint8_t **) &n4)
#define bb5 (*(uint8_t **) &n5)
#define bb6 (*(uint8_t **) &n6)
...
#define REQUIRED_SERIAL_SUPPORT \
  ...
  XV(serial, "Serial.readBytes", SERIAL_READ_BYTES, n0 = Serial.readBytes(bb1, n0); NIP) \
  XV(serial, "Serial.write", SERIAL_WRITE, n0 = Serial.write(bb1, n0); NIP) \
  ...
  XV(serial, "Serial2.readBytes", SERIAL2_READ_BYTES, n0 = Serial2.readBytes(bb1, n0); NIP) \
  XV(serial, "Serial2.write", SERIAL2_WRITE, n0 = Serial2.write(bb1, n0); NIP) \
...
# else
# define OPTIONAL_DAC_SUPPORT \
//  Y(dacWrite, dacWrite(n1, n0); DROPn(2))  // peter 2023
#endif
...
# define OPTIONAL_SPI_FLASH_SUPPORT \
  ...
  YV(spi_flash, esp_partition_get_sha256, \
      n0 = esp_partition_get_sha256((const esp_partition_t *) a1, bb0); NIP) \
...
# define OPTIONAL_RMT_SUPPORT \
  ...
  YV(rmt, rmt_get_clk_div, n0 = rmt_get_clk_div((rmt_channel_t) n1, bb0); NIP) \
  ...
  YV(rmt, rmt_get_mem_block_num, n0 = rmt_get_mem_block_num((rmt_channel_t) n1, bb0); NIP) \
  ...
  YV(rmt, rmt_write_sample, n0 = rmt_write_sample((rmt_channel_t) n3, bb2, n1, n0); NIPn(3))
#endif
...
# define OPTIONAL_I2C_SUPPORT \
  ...
  XV(Wire, "Wire.write", WIRE_WRITE, n0 = Wire.write(bb1, n0); NIP) \
...
# define OPTIONAL_SERIAL_BLUETOOTH_SUPPORT \
  ...
  XV(bluetooth, "SerialBT.readBytes", SERIALBT_READ_BYTES, n0 = bt0->readBytes(bb2, n1); NIPn(2)) \
  XV(bluetooth, "SerialBT.write", SERIALBT_WRITE, n0 = bt0->write(bb2, n1); NIPn(2)) \
  ...
  XV(bluetooth, "SerialBT.unpairDevice", SERIALBT_UNPAIR_DEVICE, \
      n0 = bt0->unpairDevice(bb1); NIP) \
  XV(bluetooth, "SerialBT.connect", SERIALBT_CONNECT, n0 = bt0->connect(c1); NIP) \
  XV(bluetooth, "SerialBT.connectAddr", SERIALBT_CONNECT_ADDR, n0 = bt0->connect(bb1); NIP) \
...
# define OPTIONAL_WIFI_SUPPORT \
  ...
  XV(WiFi, "WiFi.macAddress", WIFI_MAC_ADDRESS, WiFi.macAddress(bb0); DROP) \
...
: free. ( nf nu -- ) 2dup swap . ." free + " . ." used = " 2dup + . ." total ("
                     over + 100 -rot */ n. ." % free)" ;
: raw-ok   ."  v7.0.6.18 - rev f2948cee9bd925dd7928" cr
